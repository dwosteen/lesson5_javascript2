        ...
        ***********************************************************************************************/
        ...
        if (status == 0) { 
          ...
          *******************************************************************************/
               ...
               if (income <= 18550){
                 ...
                 taxRate = 33;
                  ...
                  tax = 18550 * 0.10 + (75300 - 18550) * 0.15 +
                        (151900 - 75300) * 0.25 + (190150 - 151900) * 0.28 +
                        (413350 - 190150) * 0.33 + (466950 - 413350 ) * 0.35 + (income - 466950) * .396;
                  taxRate = 39.6;
               }//end of nested if
          ...
          *******************************************************************************/
                ...
                //INSERT YOUR CODE BELOW// Compute tax for married seperate filers
               if (income <= 9275){
                 tax = income * 0.10;
                 taxRate = 10;
               }//end of nested if
             ...
             // Compute tax for head of household filers
               if (income <= 13250){
                 ...
                 taxRate = 33;
                  ...
                  tax = 9275 * 0.10 + (37650 - 9275) * 0.15 +
                        (130150 - 37650) * 0.25 + (210800 - 130150) * 0.28 +
...
function clearButton () {
             ...
             // clear tax estimates and tax bracket
